...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "iedit-tests" '("iedit-printable-test-lists" "with-iedit-test-" "goto-word" "marker-position-list")))
